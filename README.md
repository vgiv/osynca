...
* put.bat0 - шаблон bat-файла put.bat для рутинной отправки файлов с данного компьютера на удалённый;
* get.bat0 - шаблон bat-файла get.bat для рутинного получения файлов на данный компьютер с удалённого;
...
- Убедиться, что в системе установлен архиватор [7z](https://www.7-zip.org/).
...
- программа не понимает имена файлов, написанные с использованием букв "расширенной латиницы" типа "áèîõü" и т.д.;
